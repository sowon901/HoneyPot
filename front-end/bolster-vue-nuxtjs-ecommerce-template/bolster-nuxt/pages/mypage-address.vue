...
export default {
  ...
  methods: {
    ...
    fetchAddresses() {
      axios.get(`http://localhost:8080/mypage/mypage-address/${this.serialNumber}`, {
          headers: {
    ...
    deleteAddress(index) {
      ...
      axios.delete(`http://localhost:8080/mypage/mypage-address/${addressId}`, {
          headers: {
              'Authorization': `Bearer ${accessToken}`
          }
      })
    ...
    const request = this.isEdit
      ? axios.put(`http://localhost:8080/mypage/mypage-address/${this.address.addressId}`, addressData, {
            headers: {
                'Authorization': `Bearer ${accessToken}`
            }
        })
      : axios.post('http://localhost:8080/mypage/mypage-address', addressData, {
            headers: {
                'Authorization': `Bearer ${accessToken}`
            }
        });
