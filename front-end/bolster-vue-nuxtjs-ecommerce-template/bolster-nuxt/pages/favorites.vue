...
export default {
    ...
    setup() {
        ...
        const idols = ref([
            ...
            { name: 'GIRLSGENERATION', image: require('~/assets/img/idol-logo-image/blank.png') },
            ...
            { name: 'FROMIS_9', image: require('~/assets/img/idol-logo-image/blank.png') },
            { name: 'RIIZE', image: require('~/assets/img/idol-logo-image/blank.png') },
            ...
            { name: 'SUPERJUNIOR', image: require('~/assets/img/idol-logo-image/blank.png') },
            { name: 'TXT', image: require('~/assets/img/idol-logo-image/txt.jpg') },
            { name: 'TWICE', image: require('~/assets/img/idol-logo-image/twice.jpg') },
            { name: 'WINNER', image: require('~/assets/img/idol-logo-image/blank.png') },
            { name: 'OTHERS', image: require('~/assets/img/idol-logo-image/blank.png') },
